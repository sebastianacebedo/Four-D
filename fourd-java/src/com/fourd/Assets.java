...
/**
 * Static CSS and JavaScript assets embedded as Java string constants.
 * SiteBuilder writes these directly to output/style.css and output/script.js.
 */
public final class Assets {

    private Assets() {}   // utility class — no instantiation
...
/* ---- CTA STRIP ---- */
.cta-strip { background: var(--brown-dark); padding: 3.5rem 2rem; text-align: center; }
.cta-strip h2 {
  font-family: var(--font-display);
...
.card-specs span { font-size: 0.78rem; color: var(--gray); display: flex; align-items: center; gap: 0.4rem; }
.card-specs span strong { color: var(--brown-dark); font-weight: 500; }
.no-results { grid-column: 1 / -1; text-align: center; padding: 4rem; color: var(--gray); display: none; }
...
/* Four-D Furniture Manufacturing — Main JS */
